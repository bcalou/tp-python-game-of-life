...
class Display:
    ...
    def _init_pygame(self):
        pygame.init()
        self._screen: pygame.surface.Surface = pygame.display.set_mode(self._WINDOW_SIZE)
    ...
    def _increase_speed(self):
        if self._frequency < 128: self._frequency = self._frequency * 2
        print(f'Frequency : {self._frequency} Hz')

    def _decrease_speed(self):
        if self._frequency > 1: self._frequency = self._frequency // 2
        print(f'Frequency : {self._frequency} Hz')
